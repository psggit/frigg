...
export const SUCCESS_TRIGGER = 'SUCCESS_TRIGGER'

export const REQUEST_VIEW_CREDITS = 'REQUEST_VIEW_CREDITS'
export const SUCCESS_VIEW_CREDITS = 'SUCCESS_VIEW_CREDITS'