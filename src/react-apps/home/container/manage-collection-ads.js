...
import ViewCollectionAds from './../components/manage-collection-ads/view-ads'
...
class ManageCollectionAds extends React.Component {
  constructor(props) {
    super(props)
    this.filter = {
      stateShortName: null,
  ...
  fetchData() {
    ...
    if (location.search.length) {
      ...
      this.props.actions.fetchCollectionAds({
        city_id: null,
        offset: 0,
        limit: 10
      })
  ...
  setPage(pageObj) {
    ...
    history.pushState(queryObj, "city listing", `/home/manage-collection-ads?${getQueryUri(queryObj)}`)
  }
  ...
  applyFilter() {
    ...
    history.pushState(queryObj, "collection-ads listing", `/home/manage-collection-ads?${getQueryUri(queryObj)}`)
  ...
  render() {
    ...
    return (
      <div style={{ width: '100%' }}>
        ...
        {
          !loadingCollectionAds && collectionAdsData.ads_data.length && this.state.cityName
        ...
        <ViewCollectionAds
          collectionAdsData={collectionAdsData.ads_data}
          loadingCollectionAds={loadingCollectionAds}
          updateCollectionAdStatus={this.props.actions.updateCollectionAdStatus}
          updateCollectionAdStatusCB={this.fetchData}
        />

        {
          !loadingCollectionAds && collectionAdsData.ads_data.length
          ? <Pagination
            activePage={parseInt(this.state.activePage)}
            itemsCountPerPage={10}
            totalItemsCount={collectionAdsData.count}
