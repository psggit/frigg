    ...
    const navigationItems = [
...

      {
        ...
        nestedItems: [
         ...
         { name: 'Product Coupon', path: '/home/manage-product-coupons', id: 39, nestedItems: [] },
      ...
      },
      {
        name: 'Delivery Management',
        nestedItems: [
          { name: 'WareHouse', path: '/home/manage-warehouse', id: 43, nestedItems: [] },
          ...
          { name: 'Delivery Service Provider City Mapping', path: '/home/delivery-service-provider-city-mapping', id: 46 },
        ]
      }
    ]
    return (
