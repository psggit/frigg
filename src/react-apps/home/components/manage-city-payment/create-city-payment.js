...
class createCityPayment extends React.Component {
  ...
  handleSave () {
    ...
    Api.createCityPayment({
      ...
      jp_payment_method: CityPaymentForm.selectedJPPaymentMethodIdx === 3 ? "nodel" : CityPaymentForm.selectedJPPaymentMethodIdx === 1 ? "wallet" : " dmo wallet",
      icici_payment_method: CityPaymentForm.selectedICICIPaymentMethodIdx === 3 ? "nodel" : CityPaymentForm.selectedICICIPaymentMethodIdx === 1 ? "wallet" : "dmo wallet",
